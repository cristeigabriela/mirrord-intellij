...
class MirrordExecManager(private val service: MirrordProjectService) {
    ...
    private fun start(
        ...
        executionInfo.environment.putAll(MirrordSettingsState.instance.mirrordState.troubleshootingEnvVars())
    ...
    private fun containerStart(
        ...
        MirrordSettingsState.instance.mirrordState.troubleshootingEnvVars().forEach { (key, value) ->
            executionInfo.extraArgs.add("-e")
